      ...
      <AppContext.Provider value={value}>
        ...
        <BodySection title='News from the School'>
          <p className={css(styles.p)}>
            Lorem ipsum mesolor sit amet consectetur adipisicing elit. Iusto,
            ullam? Quislapo quam eos temporibus, voluptate error, sunt consectetur
            ducimus eaque dolorum sit excepturi doloribus officiis reprehenderit
            distinctio dignissimos adipisci a asperntokaatur.
          </p>
        </BodySection>
